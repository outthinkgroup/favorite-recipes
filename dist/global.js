...
function replaceWithForm(_ref) {
  ...
  form.innerHTML = "\n    <input type=\"text\" class=\"small-inline-input\" value=\"".concat((changeInnerTextOfEl ? changingEl.textContent : "&nbsp;").trim(), "\"/> \n    <button type=\"submit\">").concat(btnText, "</button>\n    ");
...
function changeListPrivacyMode(_ref2) {
  var list_id = _ref2.list_id,
      status = _ref2.status,
      user_id = _ref2.user_id;
  return (0, _helpers.useApi)("change-list-status", {
    list_id: list_id,
    status: status,
    user_id: user_id
  });
...
function renameList(_ref3) {
  var title = _ref3.title,
      list_id = _ref3.list_id;
  return (0, _helpers.useApi)("rename-list", {
    title: title,
    list_id: list_id
  });
}

function forkList(_ref4) {
  var list_id = _ref4.list_id,
      user_id = _ref4.user_id,
      list_title = _ref4.list_title;
  return (0, _helpers.useApi)("fork-list", {
    list_id: list_id,
    user_id: user_id,
...
window.__FAVE_RECIPE = _objectSpread(_objectSpread({}, window.__FAVE_RECIPE), {}, {
  ...
  changeListPrivacyMode: changeListPrivacyMode,
  forkList: forkList,
